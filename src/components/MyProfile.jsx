    ...
    return (
        <div className='bg-[#9fc5d8] h-[100vh] flex'>
            <div className='m-[20px] w-[20vw] '>
                ...
                {user.user.role === 'owner' ? <button onClick={showMyPropertiesComponent} className='flex justify-center border w-[100%] py-[20px] hover:bg-[#abbbd4] cursor-pointer'>
                    My Properties
                </button> : <></>}

                {user.user.role === "owner" ? <button onClick={showAddPropertyComponent} className='flex justify-center w-[100%] border py-[20px] hover:bg-[#abbbd4] cursor-pointer'>
                    Add Property
                </button> : <></>}
